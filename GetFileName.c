...
int GetFileNameGroup( DIALOG *D,void **v,void *pt) {
  ...
  DIT t0 = {
    ...
    e0,
    1,1,
    NULL,GetFileNametextbox1callback,0,0,18,9 /* args,Call back */
  };
  ...
  DIN b1 = { 
    ...
    butn1, 
    GetFileNamebutton1callback, /*  Callbak */
      NULL  /* any args */
  };
  ...
  DIL h2 = { 
    ...
    butn2, 
    GetFileNamesplbutton1callback, /*  Callbak */
      NULL  /* any args */
  };
...
//     D.StackPos = 1; // you may need it
  ...
  ModifyGetFileNameGc(&D);    /*  set colors for gui if don't like default*/
  ret= kgUi(&D);
  kgCleanUi(&D);
  return ret;
}
