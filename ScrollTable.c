...
int ScrollTableGroup( DIALOG *D,void **v,void *pt) {
  ...
  butn3[0].xpmp=NULL;
  butn3[0].xpmh=NULL;
  butn3[0].bkgr=-216216216;
  butn3[0].butncode=-2302945;
  butn3[1].sw=1;
  strcpy(butn3[1].title,(char *)"Add");
  butn3[1].xpmn=NULL;
  butn3[1].xpmp=NULL;
  butn3[1].xpmh=NULL;
  butn3[1].bkgr=-216216216;
  butn3[1].butncode=31;
  butn3[2].sw=1;
  ...
  butn7[0].sw=1;
  strcpy(butn7[0].title,(char *)"ReadIn");
  butn7[0].xpmn=NULL;
  butn7[0].xpmp=NULL;
  butn7[0].xpmh=NULL;
  ...
  butn7[1].butncode=31;
  butn7[2].sw=1;
  strcpy(butn7[2].title,(char *)"WriteTo");
  butn7[2].xpmn=NULL;
  butn7[2].xpmp=NULL;
  butn7[2].xpmh=NULL;
  ...
  e10[0].fmt = (char *)malloc(11);
  strcpy(e10[0].fmt,(char *)"MarkPos%4d");
  e10[0].v=(void *)v[50];
  e10[0].sw=1;
  e10[0].noecho=0;
  e10[0].img=NULL;
  DIT t10 = { 
    ...
    e10,
    1,1,
    NULL,ScrollTabletextbox3callback,0,0,18,9 /* args,Call back */
  };
  ...
  DIN b11 = { 
    ...
    butn11, 
    ScrollTablebutton6callback, /*  Callbak */
      NULL  /* any args */
  };
