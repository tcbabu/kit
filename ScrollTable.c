...
#include "GclrScrollTable.c"
  int ScrollTableGroup ( DIALOG *D , void **v , void *pt ) {
      ...
      DIT T0 = {
          'T' , 8 , 66 , 925 , 557 , 20 , 2 , 24 , e0 , 0 , 1 , NULL , ScrollTabletablebox1callback , 0 , 0 , 16 , 10 /* args , Call back */
      };
      ...
      T0.item = -1;
      DIV v1 = {
          'v' , 925 , 66 , 945 , 558 , 0 , 100.000000 , 0.000000 , 5.000000 , NULL , ScrollTablevertscroll1callback /* *args , callback */
      };
      ...
      butn2 [ 1 ] .butncode = '';
      DIL h2 = {
          'h' , 336 , 561 , 515 , 592 , 2 , 0 , 84 , 25 , 2 , 1 , 2 , 0.500000 , 0 , 0 , 0 , 1 , /* button type and roundinfg factor  \
      ...
      butn3 [ 2 ] .butncode = '';
      DIN b3 = {
          'n' , 712 , 36 , 914 , 66 , 2 , 2 , 64 , 24 , 3 , 1 , 4 , 0.500000 , 0 , 0 , 0 , 1 , /* button type and roundinfg factor  \
              ( 0-0.5 ) , bordr , hide , nodrawbkgr*/
      ...
      butn4 [ 1 ] .butncode = '';
      DIN b4 = {
          'n' , 13 , 36 , 148 , 66 , 2 , 2 , 64 , 24 , 2 , 1 , 1 , 0.500000 , 0 , 0 , 0 , 1 , /* button type and roundinfg factor  \
              ( 0-0.5 ) , bordr , hide , nodrawbkgr*/
      ...
      e5 [ 0 ] .img = NULL;
      DIT t5 = {
          't' , 90 , 6 , 270 , 34 , 20 , 1 , 1 , e5 , 1 , 1 , NULL , ScrollTabletextbox1callback , 0 , 0 , 18 , 9 /* args , Call back */
      };
      ...
      butn6 [ 0 ] .butncode = '';
      DIN b6 = {
          'n' , 13 , 6 , 90 , 36 , 2 , 2 , 72 , 24 , 1 , 1 , 2 , 0.500000 , 0 , 0 , 0 , 1 , /* button type and roundinfg factor  \
              ( 0-0.5 ) , bordr , hide , nodrawbkgr*/
      ...
      butn7 [ 6 ] .butncode = '}';
      DIN b7 = {
          'n' , 148 , 36 , 613 , 66 , 2 , 2 , 64 , 24 , 7 , 1 , 1 , 0.500000 , 0 , 0 , 0 , 1 , /* button type and roundinfg factor  \
              ( 0-0.5 ) , bordr , hide , nodrawbkgr*/
      ...
      butn8 [ 0 ] .butncode = '';
      DIN b8 = {
          'n' , 270 , 6 , 344 , 36 , 2 , 2 , 64 , 24 , 1 , 1 , 2 , 0.500000 , 0 , 0 , 0 , 1 , /* button type and roundinfg factor  \
              ( 0-0.5 ) , bordr , hide , nodrawbkgr*/
      ...
      e9 [ 0 ] .img = NULL;
      DIT t9 = {
          't' , 340 , 6 , 520 , 36 , 20 , 1 , 1 , e9 , 1 , 1 , NULL , ScrollTabletextbox2callback , 0 , 0 , 18 , 9 /* args , Call back */
      };
...
//     D.StackPos = 1; // you may need it
      ...
      ModifyScrollTableGc ( & D ) ; /* set colors for gui if donot like default*/
      ret = kgUi ( & D ) ;
      kgCleanUi ( & D ) ;
      return ret;
  }
