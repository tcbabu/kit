...
int kgeditGroup( DIALOG *D,void **v,void *pt) {
  ...
  DIT t5 = { 
    ...
    e5,
    1,1,
    NULL,kgeditKEDmarkcallback ,0 ,0,5,9 
  };
  ...
  DIT t15 = { 
    ...
    e15,
    1,1,
    NULL,kgeditKEDstboxcallback ,0 ,0,5,9 
  };
    /* *args,Callback,border,hide,font,fontsize */
  ...
  DIT t16 = { 
    ...
    e16,
    1,1,
    NULL,kgeditKEDrtboxcallback ,0 ,0,5,9 
  };
    /* *args,Callback,border,hide,font,fontsize */
