...
kit	: ScrollTable.o ScrollTableCallbacks.o ScrollTablemain.o GetFileName.o
	 $(CC) -o kit ScrollTable.o ScrollTableCallbacks.o ScrollTablemain.o GetFileName.o -I$(KULINA)/include $(KULINA)/lib/libkulina.a $(KULINA)/lib/libgm.a -L/usr/X11R6/lib -lX11 -lXext -lm -lpthread -lz -lbz2 -lGL
